...
export class HealthNFTMarketplace__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class HealthNFTMarketplace extends ethereum.SmartContract {
  static bind(address: Address): HealthNFTMarketplace {
    return new HealthNFTMarketplace("HealthNFTMarketplace", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): HealthNFTMarketplace__getListingResultValue0Struct {
    ...
    return changetype<HealthNFTMarketplace__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<HealthNFTMarketplace__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<HealthNFTMarketplace__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
