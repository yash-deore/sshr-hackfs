...
export class HealthDataNFT extends ethereum.SmartContract {
  static bind(address: Address): HealthDataNFT {
    return new HealthDataNFT("HealthDataNFT", address);
  }
  ...
  getTokenURI(index: BigInt): string {
  ...
  try_getTokenURI(index: BigInt): ethereum.CallResult<string> {
  ...
  mintNft(senderAddress: Address, _tokenURI: string): BigInt {
  ...
  s_requestIdToOwner(param0: BigInt): Address {
    let result = super.call(
      "s_requestIdToOwner",
      "s_requestIdToOwner(uint256):(address)",
  ...
  try_s_requestIdToOwner(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "s_requestIdToOwner",
      "s_requestIdToOwner(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
